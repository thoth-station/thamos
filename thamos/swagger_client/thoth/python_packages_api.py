...
class PythonPackagesApi(object):
    ...
    def get_package_metadata(self, name, version, index, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_package_metadata_with_http_info(
                name, version, index, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_package_metadata_with_http_info(
                name, version, index, **kwargs
            )  # noqa: E501
            return data

    def get_package_metadata_with_http_info(
        ...
        if "name" not in params or params["name"] is None:
            raise ValueError(
                "Missing the required parameter `name` when calling `get_package_metadata`"
            )  # noqa: E501
        # verify the required parameter 'version' is set
        if "version" not in params or params["version"] is None:
            raise ValueError(
                "Missing the required parameter `version` when calling `get_package_metadata`"
            )  # noqa: E501
        # verify the required parameter 'index' is set
        if "index" not in params or params["index"] is None:
            raise ValueError(
                "Missing the required parameter `index` when calling `get_package_metadata`"
            )  # noqa: E501
    ...
    def list_python_package_versions(self, name, **kwargs):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.list_python_package_versions_with_http_info(
                name, **kwargs
            )  # noqa: E501
        else:
            (data) = self.list_python_package_versions_with_http_info(
                name, **kwargs
            )  # noqa: E501
            return data
    ...
    def list_python_package_versions_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        if "name" not in params or params["name"] is None:
            raise ValueError(
                "Missing the required parameter `name` when calling `list_python_package_versions`"
            )  # noqa: E501
