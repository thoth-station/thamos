...
class BuildlogsApi(object):
    ...
    def parse_log(self, body, **kwargs):  # noqa: E501
        """Parse Docker build log or installation log and show installed packages.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.parse_log(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Log body: A full log. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.parse_log_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.parse_log_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def parse_log_with_http_info(self, body, **kwargs):  # noqa: E501
        """Parse Docker build log or installation log and show installed packages.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.parse_log_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `parse_log`")  # noqa: E501
