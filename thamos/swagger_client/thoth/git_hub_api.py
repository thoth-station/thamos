...
class GitHubApi(object):
    ...
    def schedule_thamos_advise(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.schedule_thamos_advise(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.schedule_thamos_advise_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.schedule_thamos_advise_with_http_info(body, **kwargs)  # noqa: E501
            return data
    ...
    def schedule_thamos_advise_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.schedule_thamos_advise_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `schedule_thamos_advise`")  # noqa: E501
