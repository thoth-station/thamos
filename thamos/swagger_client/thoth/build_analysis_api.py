...
class BuildAnalysisApi(object):
    ...
    def post_build_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'registry_user', 'registry_password', 'environment_type', 'origin', 'debug', 'registry_verify_tls', 'force']  # noqa: E501
        ...
        if 'registry_verify_tls' in params:
            query_params.append(('registry_verify_tls', params['registry_verify_tls']))  # noqa: E501
        if 'force' in params:
