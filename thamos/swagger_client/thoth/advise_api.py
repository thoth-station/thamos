...
class AdviseApi(object):
    ...
    def post_advise_python_with_http_info(self, body, recommendation_type, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'recommendation_type', 'count', 'limit', 'origin', 'source_type', 'dev', 'debug', 'force', 'github_event_type', 'github_check_run_id', 'github_installation_id', 'github_base_repo_url']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
