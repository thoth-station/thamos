...
class KebechetApi(object):
    ...
    def initialize_repo(self, body, **kwargs):  # noqa: E501
        """Initialize the user's provided repository.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.initialize_repo(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.initialize_repo_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.initialize_repo_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def initialize_repo_with_http_info(self, body, **kwargs):  # noqa: E501
        """Initialize the user's provided repository.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.initialize_repo_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `initialize_repo`")  # noqa: E501
