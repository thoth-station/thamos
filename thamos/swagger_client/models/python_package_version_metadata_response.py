...
class PythonPackageVersionMetadataResponse(object):
    ...
    def parameters(self):
        ...
        :return: The parameters of this PythonPackageVersionMetadataResponse.  # noqa: E501
        :rtype: object
        """
    ...
    def parameters(self, parameters):
        """Sets the parameters of this PythonPackageVersionMetadataResponse.

        Parameters echoed back to user for debugging  # noqa: E501

        :param parameters: The parameters of this PythonPackageVersionMetadataResponse.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PythonPackageVersionMetadataResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PythonPackageVersionMetadataResponse):
            return False
