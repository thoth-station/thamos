...
class InlineResponse200HardwareEnvironments(object):
    ...
    def __init__(self, cpu_cores=None, cpu_family=None, cpu_model=None, cpu_model_name=None, cpu_physical_cpus=None, cpu_vendor=None, gpu_cores=None, gpu_memory_size=None, gpu_model_name=None, gpu_vendor=None, ram_size=None):  # noqa: E501
