...
class AdviserResultResponseResultReportPipelineBoots(object):
    ...
    @property
    def unit_run(self):
        """Gets the unit_run of this AdviserResultResponseResultReportPipelineBoots.  # noqa: E501

        Flag set to true if the pipeline unit was run during the resolution process   # noqa: E501

        :return: The unit_run of this AdviserResultResponseResultReportPipelineBoots.  # noqa: E501
        :rtype: bool
        """
    ...
    def unit_run(self, unit_run):
        """Sets the unit_run of this AdviserResultResponseResultReportPipelineBoots.

        Flag set to true if the pipeline unit was run during the resolution process   # noqa: E501

        :param unit_run: The unit_run of this AdviserResultResponseResultReportPipelineBoots.  # noqa: E501
        :type: bool
        """
        if unit_run is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AdviserResultResponseResultReportPipelineBoots, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdviserResultResponseResultReportPipelineBoots):
            return False
