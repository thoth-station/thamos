...
class InlineResponse2002SoftwareEnvironments(object):
    ...
    def __init__(self, cuda_version=None, environment_name=None, environment_type=None, image_name=None, image_sha=None, os_name=None, os_version=None, python_version=None):  # noqa: E501
