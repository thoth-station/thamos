...
class PythonStack(object):
    ...
    def requirements_format(self, requirements_format):
        ...
        if requirements_format not in allowed_values:
            raise ValueError(
                "Invalid value for `requirements_format` ({0}), must be one of {1}"  # noqa: E501
                .format(requirements_format, allowed_values)
            )
