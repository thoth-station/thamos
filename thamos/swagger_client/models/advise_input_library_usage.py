...
class AdviseInputLibraryUsage(object):
    ...
    """
    openapi_types = {"report": "object", "version": "str"}

    attribute_map = {"report": "report", "version": "version"}

    def __init__(
        self, report=None, version=None, local_vars_configuration=None
    ):  # noqa: E501
        """AdviseInputLibraryUsage - a model defined in OpenAPI"""  # noqa: E501
    ...
    def report(self, report):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and report is None
        ):  # noqa: E501
            raise ValueError(
