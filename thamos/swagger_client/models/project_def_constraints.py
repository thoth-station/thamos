...
class ProjectDefConstraints(object):
    ...
    def name(self):
        ...
        :return: The name of this ProjectDefConstraints.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProjectDefConstraints.

        Name of the package that was constrained  # noqa: E501

        :param name: The name of this ProjectDefConstraints.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def version(self):
        ...
        :return: The version of this ProjectDefConstraints.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this ProjectDefConstraints.

        Version range specifier for the constrain  # noqa: E501

        :param version: The version of this ProjectDefConstraints.  # noqa: E501
        :type: str
        """
        if version is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProjectDefConstraints, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProjectDefConstraints):
            return False
